...
define(
  ...
  function () {
    ...
    var isTextBlock = function (editor, node) {
      //this is the only modification from stock TinyMCE lists plugin... stops divs from converting to lists automatically
      return node && (node.nodeName != "DIV") && !!editor.schema.getTextBlockElements()[node.nodeName];
    };
...
define(
  ...
  function (PluginManager, Tools, VK, Indent, Outdent, ToggleList, Delete, NodeType) {
    ...
    PluginManager.add('blockade_lists', function (editor) {
      setupUi(editor);
      Delete.setup(editor);
